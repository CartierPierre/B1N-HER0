class Langue
    ...
    def initialize(langue) 
        ...
        @langueEn = {
            ...
            pasInternetOffline: "A connection to with the server couldn't be established so you can't sign in with an online account. If needed, you can create a temporary offline account, the statistics of this account can be merged with an online account later.",
            pasInternetOnline: "A connection to with the server couldn't be established so you can't synchronise your data for now. You will be able to when the connexion can be achieved.",
