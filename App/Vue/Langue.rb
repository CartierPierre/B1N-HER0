class Langue
    ...
    def initialize(langue) 
        ...
        @langueFr = {
            ...
            pasInternetInscription: "La connexion avec le serveur n'a pu être établie. Il est donc impossible de vous inscrire avec un compte en ligne. Si besoin, nous vous invitons à créer un compte local temporaire. Les statistiques de se dernier pourront être fusionnées ultérieurement avec votre compte en ligne.",
            pasInternetOffline: "La connexion avec le serveur n'a pu être établie. Il est donc impossible de vous connecter sur un compte en ligne. Si besoin, nous vous invitons à créer un compte local temporaire. Les statistiques de se dernier pourront être fusionnées ultérieurement avec votre compte en ligne.",
        ...
        @langueEn = {
            ...
            profil: "Profile",
            pseudo: "Username",
            pseudoChange: "Your password has been changed.",
